...
fun BoxWithConstraintsScope.OnboardingSplashLogin(
    ...
    Column(
        ...
        Image(
            ...
            painter = painterResource(id = R.drawable.onix_logo),
            contentScale = ContentScale.FillBounds,
            contentDescription = "Onix Wallet logo"
        )
...
private fun LocalAccountExplanation() {
    Text(
        ...
        text = "ENTRAR CON CUENTA SIN CONEXIÓN",
        style = UI.typo.c.style(
            color = Gray,
            fontWeight = FontWeight.ExtraBold
        )
    ...
    Text(
        ...
        text = "Sus datos se guardarán solo localmente en su teléfono. " +
                "Corre el riesgo de perder sus datos si desinstala la aplicación o cambia su dispositivo. " +
                "Para evitar la pérdida de datos, recomendamos exportar copias de seguridad desde la configuración con regularidad.",
        style = UI.typo.c.style(
            color = Gray,
            fontWeight = FontWeight.Medium
        )
